    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.CharField(default=None, editable=False, max_length=64, verbose_name='History UUID')),
                ...
                ('success_info', models.TextField(blank=True, default='', editable=False, null=True, verbose_name='Success Info')),
                ('request_info', models.TextField(blank=True, default='', editable=False, null=True, verbose_name='Request Info')),
                ...
                ('token', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='wallet.token')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('finished_time', models.DateTimeField(blank=True, default=None, editable=False, null=True, verbose_name='Finished Time')),
                ('block_time', models.DateTimeField(blank=True, default=None, editable=False, null=True, verbose_name='Block Time')),
                ('counterparty', models.ForeignKey(blank=True, default=None, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='wallet_history_deposit', to=settings.AUTH_USER_MODEL, verbose_name='Internal CounterParty ID')),
                ('deposit', models.ForeignKey(blank=True, default=None, editable=False, help_text='Owner of the order', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='wallet_history_deposit', to='wallet.address')),
                ('token', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='wallet.token')),
            ],
            options={
