...
class ChainAdmin(admin.ModelAdmin):
    list_display = ("chain_name","chain_network","chain_symbol","created_time","updated_time","explorer_url")
    search_fields = ("chain_name", "chain_symbol")
    ordering = ('-updated_time',)
    empty_value_display = '-'

class TokenAdmin(admin.ModelAdmin):
    list_display = ("chain","contract_address","token_symbol","token_name","is_active","created_time","updated_time")
